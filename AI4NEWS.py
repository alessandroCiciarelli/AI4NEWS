...
st.markdown('<iframe width="100%" style="auto !important;100%" src="https://rss.app/embed/v1/magazine/C3ws5QRv5zQnUXwb" id="myIframe" frameborder="0"></iframe><br>', unsafe_allow_html=True)
st.markdown('<script> \
