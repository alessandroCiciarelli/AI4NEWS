...
def stampa_Notizie_new(notizie_da_Stapare):
	...
	for n in notizie_da_Stapare["articles"]:
		...
		#audio_bytes = audio_file.read()
		st.markdown("<center><div class='' style='width:90%;border:3px inset #b4b6b7;border-width:3px;border-style:inset;border-color:#b4b6b7;border-radius:10px 25px 25px 30px;-moz-border-radius:10px 25px 25px 30px;-webkit-border-radius:10px 25px 25px 30px;-webkit-box-shadow:-8px -14px 1000px 0px #d6d6d6 ;-moz-box-shadow:-8px -14px 1000px 0px #d6d6d6 ;box-shadow:-8px -14px 1000px 0px #d6d6d6 ;padding:15px;margin-bottom: 25px;'>\
