...
#st.markdown('<iframe width="100%" style="height:1620px" src="https://rss.app/embed/v1/magazine/C3ws5QRv5zQnUXwb" id="myIframe" frameborder="0"></iframe><br>', unsafe_allow_html=True)
...
def stampa_Notizie_new(notizie_da_Stapare):
	...
	for n in notizie_da_Stapare["articles"]:
		...
		<div class='row' style='margin-bottom:15px;width:90%;padding:15px;margin-bottom: 10px;'>\
  		...
  		<div class='col-sm-5'><img src='" + immagine + "' class='figure-img img-fluid rounded img-hover-zoom  img-hover-zoom--slowmo' style=''>\
		...
		st.markdown("<hr style='border-top: 1px solid #dddddd;margin:20px;' />", unsafe_allow_html=True)
		#st.audio(audio_bytes, format='audio/mp3')
		#st.markdown("<br>",unsafe_allow_html=True)
...
Scelte = ["Notizie Popolari","Ultime Notizie","Notizie del Momento","Cerca le notizie su ciò che ti interessa"]
